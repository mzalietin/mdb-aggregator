...
import me.mzalietin.imdbproject.movierating.serde.ValidatingDeserializer;
...
public class MovieRatingAggregatorConfig {
    ...
    public Serde<MovieRatingEvent> valueSerde() {
        ...
        Map<String, Object> props = new HashMap<>();
        props.put(JacksonJsonDeserializer.TRUSTED_PACKAGES, "me.mzalietin.imdbproject.movierating.event.in");
        props.put(JacksonJsonDeserializer.TYPE_MAPPINGS,
            "review_created:me.mzalietin.imdbproject.movierating.event.in.MovieReviewCreated,"
                + " review_updated:me.mzalietin.imdbproject.movierating.event.in.MovieReviewUpdated,"
                + " review_deleted:me.mzalietin.imdbproject.movierating.event.in.MovieReviewDeleted");
